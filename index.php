...
$is_auth = rand(0, 1);
$user_name = 'Александр Краснов'; // укажите здесь ваше имя
            ...
            <?php foreach($posts as $post): ?>
                <article class="popular__post post">
                    ...
                    <div class="post-link__wrapper">
                        <a class="post-link__external" title="Перейти по ссылке" <?php echo 'href="http://'.$post['content'].'"';  ?>>
                    ...
                    <div class="post-photo__image-wrapper">
                        <img alt="Фото от пользователя" width="360" height="240" <?php echo 'src="img/'.$post['content'].'"';  ?>>
                    </div>
                        ...
                        <div class="post__author">
                            <a class="post__author-link" href="#" title="Автор">
                                <div class="post__avatar-wrapper">
                                    <img alt="Аватар пользователя" class="post__author-avatar" <?php echo 'src="img/'.$post['avatar'].'"';  ?>>
                                </div>
